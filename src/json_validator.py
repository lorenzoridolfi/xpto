...
def validate_json_output(output: str) -> Tuple[bool, str]:
    ...
    try:
        ...
        elif "verification_status" in parsed_output and "verification_results" in parsed_output:
            schema = schemas.get("information_verifier")
        elif "quality_status" in parsed_output and "quality_assessment" in parsed_output:
