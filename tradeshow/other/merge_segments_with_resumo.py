...
input_segments_path = os.path.join(
    "/Users/lorenzo/Sync/Source/AI/autogen/tradeshow", "input", "segments.json"
)
resumo_path = os.path.join(
    "/Users/lorenzo/Sync/Source/AI/autogen/tradeshow/other", "resumo_segmentos.json"
)
output_segments_path = os.path.join(
    "/Users/lorenzo/Sync/Source/AI/autogen/tradeshow", "other", "segments.json"
)
# Use only the correct synthetic user schema in the schema folder:
schema_path = os.path.join(
    "/Users/lorenzo/Sync/Source/AI/autogen/tradeshow", "schema", "segments_schema.json"
)
